...
func (c *Comp) call1ret0(call *Call, maxdepth int) func(env *Env) {
	...
	if reflect.KindToType(k) == t.ReflectType() {
		...
		case xr.Bool:
			...
			if arg.Const() {
				argconst := xr.ValueOf(arg.Value).Bool()
		...
		case xr.Int:
			...
			if arg.Const() {
				argconst := int(xr.ValueOf(arg.Value).Int())
				if funsym != nil && funupn == maxdepth-1 {
		...
		case xr.Int8:
			if arg.Const() {
				argconst := int8(xr.ValueOf(arg.Value).Int())
				if funsym != nil && funupn == maxdepth-1 {
		...
		case xr.Int16:
			if arg.Const() {
				argconst := int16(xr.ValueOf(arg.Value).Int())
				if funsym != nil && funupn == maxdepth-1 {
		...
		case xr.Int32:
			if arg.Const() {
				argconst := int32(xr.ValueOf(arg.Value).Int())
				if funsym != nil && funupn == maxdepth-1 {
		...
		case xr.Int64:
			if arg.Const() {
				argconst := xr.ValueOf(arg.Value).Int()
				if funsym != nil && funupn == maxdepth-1 {
		...
		case xr.Uint:
			if arg.Const() {
				argconst :=
					...
					uint(xr.ValueOf(arg.Value).Uint())
				if funsym != nil && funupn == maxdepth-1 {
		...
		case xr.Uint8:
			if arg.Const() {
				argconst :=
					...
					uint8(xr.ValueOf(arg.Value).Uint())
				if funsym != nil && funupn == maxdepth-1 {
					var cachedfun func(
						uint8)
					ret = func(env *Env) {
		...
		case xr.Uint16:
			if arg.Const() {
				argconst :=
					...
					uint16(xr.ValueOf(arg.Value).Uint())
				if funsym != nil && funupn == maxdepth-1 {
					var cachedfun func(
		...
		case xr.Uint32:
			if arg.Const() {
				argconst :=
					...
					uint32(xr.ValueOf(arg.Value).Uint())
				if funsym != nil && funupn == maxdepth-1 {
					var cachedfun func(
		...
		case xr.Uint64:
			if arg.Const() {
				argconst := xr.ValueOf(arg.Value).Uint()
				if funsym != nil && funupn == maxdepth-1 {
					var cachedfun func(
		...
		case xr.Uintptr:
			if arg.Const() {
				argconst :=
					...
					uintptr(xr.ValueOf(arg.Value).Uint())
				if funsym != nil && funupn == maxdepth-1 {
					var cachedfun func(
		...
		case xr.Float32:
			if arg.Const() {
				argconst :=
					...
					float32(xr.ValueOf(arg.Value).Float())
				if funsym != nil && funupn == maxdepth-1 {
					var cachedfun func(
		...
		case xr.Float64:
			if arg.Const() {
				argconst := xr.ValueOf(arg.Value).Float()
				if funsym != nil && funupn == maxdepth-1 {
					var cachedfun func(
		...
		case xr.Complex64:
			if arg.Const() {
				argconst :=
					...
					complex64(xr.ValueOf(arg.Value).Complex())
				if funsym != nil && funupn == maxdepth-1 {
					var cachedfun func(
		...
		case xr.Complex128:
			if arg.Const() {
				argconst := xr.ValueOf(arg.Value).Complex()
				if funsym != nil && funupn == maxdepth-1 {
					var cachedfun func(
		...
		case xr.String:
			if arg.Const() {
				argconst := xr.ValueOf(arg.Value).String()
				if funsym != nil && funupn == maxdepth-1 {
					var cachedfun func(
