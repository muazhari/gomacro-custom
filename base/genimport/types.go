...
const (
	...
	// 1. write a file $GOPATH/src/github.com/muazhari/gomacro-custom/imports/$PKGPATH.go containing a single func init()
	...
	// 1. write a file $GOPATH/src/github.com/muazhari/gomacro-custom/imports/thirdparty/$PKGPATH.go containing a single func init()
	//    i.e. *inside* gomacro sources
	// 2. tell the user to recompile gomacro
	ImThirdParty
